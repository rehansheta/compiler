 ...
 * @author Rehan
 */
public class ASTWriteInt extends ASTStatements {
    ...
    public void print(int nodeId) {
        ...
        TL13Grammers.ASTWriter.writeNode("WriteInt", Compiler.ASTnodeCounter, this);
    ...
    public String typeCheck() {
        ...
        if (expression.typeCheck().equalsIgnoreCase(ASTConstants.TYPE_INT) || expression.typeCheck().equalsIgnoreCase(ASTConstants.TYPE_CHAR)) {
            this.type = ASTConstants.TYPE_SUCCESS_MESSAGE;
        } else {
            this.type = ASTConstants.TYPE_ERROR;
            System.err.println(ASTConstants.TYPE_ERROR_MESSAGE.replace("######", "WriteInt"));
        }
    ...
    public void genILOC(Block entryBlock) {
        ...
        inst.opCode = ILOCConstants.WRITEINT;
